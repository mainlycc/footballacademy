...
export const PLAYER_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Obecność na treningu", badge: "Obecność na treningu FA" },
      {
        label: "Całkowite wypełnienie profilu zawodnika FA",
        badge: "Całkowite wypełnienie profilu zawodnika FA",
      },
      { label: "Dodanie zdjęcia profilowego", badge: "Dodanie zdjęcia profilowego FA" },
      ...
      {
        label: "Obecność na treningu wakacyjnym",
        badge: "Obecność na treningu wakacyjnym FA",
      },
      ...
      {
        label: "Najbardziej uśmiechnięty zawodnik",
        badge: "Najbardziej uśmiechnięty zawodnik FA",
      },
